...
export default function PageNumberTool() {
  ...
  const [customFileName, setCustomFileName] = useState('paperknifeAR-numbered')
  ...
  const handleFile = async (file: File) => {
    ...
    } catch (err) { logger.error('page_number_failed', { error: err }) } finally { setIsProcessing(false); setDownloadUrl(null) }
  }
