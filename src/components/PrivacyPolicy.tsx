...
const PrivacyWeb = () => {
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-obsidian-950 text-obsidian-950 dark:text-obsidian-100 selection:bg-ember-500 selection:text-white p-6 md:p-12 pb-24">
      <div className="max-w-6xl mx-auto space-y-6">
        
        {/* Hero Section */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
          <div className="md:col-span-8 bg-obsidian-50 dark:bg-obsidian-900 rounded-[2.5rem] p-10 md:p-16 border border-obsidian-200 dark:border-white/5 relative overflow-hidden flex flex-col justify-center">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-obsidian-500 dark:text-obsidian-500 font-medium max-w-lg leading-relaxed">
                PaperKnifeAR isn't just "private" by policy; it's private by architecture. We've eliminated the server entirely, ensuring that "No Data Found" is a technical reality, not just a promise.
              </p>
            </div>
          </div>

          <div className="md:col-span-4 bg-obsidian-900 text-white rounded-[2.5rem] p-10 flex flex-col items-center justify-center text-center relative overflow-hidden border border-white/5 shadow-2xl">
             <div className="absolute top-0 right-0 p-6 opacity-10">
                <Lock size={120} />
             </div>
             <div className="w-16 h-16 bg-obsidian-50/10 rounded-2xl flex items-center justify-center mb-6 backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-8 bg-obsidian-50 dark:bg-obsidian-900 rounded-[2.25rem] border border-obsidian-200 dark:border-white/5 shadow-sm space-y-4">
            <div className="w-10 h-10 bg-ember-50 dark:bg-ember-900/20 text-ember-500 rounded-xl flex items-center justify-center">
              <Cpu size={20} />
            </div>
            <h3 className="font-black text-sm uppercase tracking-widest dark:text-white">RAM Processing</h3>
            <p className="text-sm text-obsidian-500 dark:text-obsidian-500 leading-relaxed font-medium">
        ...
        <div className="p-10 bg-emerald-500 text-white rounded-[3rem] flex flex-col md:flex-row items-center gap-10 relative overflow-hidden shadow-2xl shadow-emerald-500/20">
           ...
           <div className="w-20 h-20 bg-obsidian-50/20 rounded-full flex items-center justify-center shrink-0 backdrop-blur-md border border-white/20">
              <HistoryIcon size={32} />
           </div>
           <div className="flex-1 text-center md:text-left relative z-10">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                 <a href="https://github.com/VLTMED/PaperKnifeAR" target="_blank" className="px-8 py-3 bg-obsidian-50 text-emerald-600 rounded-xl font-black uppercase text-[10px] tracking-widest hover:scale-105 transition-transform flex items-center gap-2 shadow-lg">
        ...
        <div className="pt-12 text-center opacity-30">
           ...
           <p className="text-[10px] font-black uppercase tracking-[0.5em] text-obsidian-500">Privacy Protocol v1.0.9 Stable</p>
        </div>
      </div>
    </div>
  )
  ...
  return (
    <NativeToolLayout title="Privacy" description="Data Security Spec" actions={null}>
      <div className="px-4 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-4">
        ...
        {/* Status Card */}
        <div className="bg-obsidian-50 dark:bg-obsidian-900 rounded-[2rem] p-6 border border-obsidian-200 dark:border-white/5 shadow-sm flex items-center gap-5">
        ...
        {/* Protocol List */}
        <div className="bg-obsidian-50 dark:bg-obsidian-900 rounded-[2rem] border border-obsidian-200 dark:border-white/5 shadow-sm overflow-hidden divide-y divide-obsidian-100 dark:divide-white/5">
           <PrivacyItem 
             icon={ServerOff} 
             title="No Cloud Compute" 
             desc="All PDF logic runs on your phone's CPU. No document data is ever uploaded to any server." 
             color="text-ember-500 bg-ember-50 dark:bg-ember-900/20"
           />
           <PrivacyItem 
             icon={EyeOff} 
             title="No Telemetry" 
        ...
        {/* Pledge Card */}
        <div className="bg-obsidian-900 text-white rounded-[2rem] p-8 relative overflow-hidden">
           <div className="absolute top-0 right-0 p-6 opacity-10">
              <Lock size={80} />
           </div>
           <h3 className="text-lg font-black uppercase tracking-tight mb-3">Integrity Pledge</h3>
           <p className="text-xs text-obsidian-500 leading-relaxed font-medium mb-6">
              PaperKnifeAR is a transparent document workspace. We believe your data belongs to you, and we build tools that make that technically enforceable.
           </p>
           <a 
             href="https://github.com/VLTMED/PaperKnifeAR" 
             target="_blank" 
             className="flex items-center justify-center gap-2 py-3.5 bg-obsidian-50 text-obsidian-950 rounded-xl font-black uppercase text-[10px] tracking-widest active:scale-95 transition-transform"
           >
              Audit Source Code <ExternalLink size={14} />
           </a>
        </div>

        <p className="text-[8px] font-black uppercase text-center text-obsidian-500 tracking-[0.5em] pt-8">Handcrafted for Security</p>
      </div>
    </NativeToolLayout>
  )
}
...
const PrivacyItem = ({ icon: Icon, title, desc, color }: { icon: any, title: string, desc: string, color: string }) => (
  <div className="p-6 flex gap-5">
    ...
    <div className="min-w-0">
      ...
      <p className="text-xs text-obsidian-500 dark:text-obsidian-500 leading-relaxed font-medium">{desc}</p>
    </div>
  </div>
)
